...
sink("Rat_spatialCJS_trans_moveHet_simple.jags")
cat("
...
CJS_data$ALT<-NULL			### remove size and sex info
...
geninits =  function() {list(z=z,daily.phi=runif((T-1),0.9,1), lam0=rgamma(T,0.1,0.1)) }
...
# Fitting the model in JAGS
ratmodel <- jags(CJS_data, inits, params, "S:\\ConSci\\DptShare\\SteffenOppel\\RSPB\\UKOT\\Henderson\\Analyses\\Rats\\Bayes_SECR\\Rat_spatialCJS_trans_moveHet_simple.jags", n.chains = nc, n.thin = nt, n.iter = ni, n.burnin = nb, parallel=T, n.cores=nc)
