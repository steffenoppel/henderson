...
sink("Rat_spatialCJS_FINAL.jags")
cat("
...
setwd("S:\\ConSci\\DptShare\\SteffenOppel\\RSPB\\UKOT\\Henderson\\Analyses\\Rats\\Bayes_SECR")
setwd("C:\\STEFFEN\\RSPB\\UKOT\\Henderson\\Analyses\\Rats\\Bayes_SECR")
load("S:\\ConSci\\DptShare\\SteffenOppel\\RSPB\\UKOT\\Henderson\\Analyses\\Rats\\Bayes_SECR\\spatialCJS_input_8occ_cov.RData")
load("C:\\STEFFEN\\RSPB\\UKOT\\Henderson\\Analyses\\Rats\\Bayes_SECR\\spatialCJS_input_8occ_cov.RData")
...
geninits =  function() {list(z=z,daily.phi=runif((T-1),0.9,1), lam0=matrix(rgamma(T*3,0.1,0.1),ncol=max(ttyp))) }
...
# Fitting the model in JAGS
ratmodel <- jags(CJS_data, inits, params, "S:\\ConSci\\DptShare\\SteffenOppel\\RSPB\\UKOT\\Henderson\\Analyses\\Rats\\Bayes_SECR\\Rat_spatialCJS_FINAL.jags", n.chains = nc, n.thin = nt, n.adapt=na, n.iter = ni, n.burnin = nb, parallel=T, n.cores=nc)
...
write.table(out,"Henderson_spatialCJS_output_8occ_FINAL.csv", sep=",", row.names=F)
dim(out)
...
##########################################################################################################
surv.dat<-out[1:6,]			## annual survival
